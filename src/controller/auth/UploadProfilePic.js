...
const UploadProfilePic = async (req, res, next) => {
    ...
    if (req.uploader == 'customer') {
        ...
        res.cookie('profilePicUrl', req.filesUrls[0], {httpOnly: true, sameSite: 'None', secure: true}).status(200).json(new ApiResponse(200, 'success', {profilePicUrl: req.filesUrls[0]}))
        return
    }
