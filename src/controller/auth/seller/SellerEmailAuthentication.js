        ...
        if (foundUser == null) {
            ...
            if (!isPasswordVerified) {
                ...
                if (foundUser.refreshToken) {
                    ...
                    res.cookie('accessToken', accessToken).cookie('_id', ((foundUser._id).toHexString())).cookie('profilePicUrl', foundUser.profilePicUrl ? foundUser.profilePicUrl : '').status(200).json(new ApiResponse(200, 'Logged In Successfully'))    
                    return
                }
