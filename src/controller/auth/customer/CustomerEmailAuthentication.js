        ...
        if (foundUser == null) {
            ...
            if (!isPasswordVerified) {
                ...
                if (foundUser.refreshToken) {
                    ...
                    res.cookie('userMode', 'customer', {httpOnly: false, sameSite: 'None', secure: true}).cookie('accessToken', accessToken, {httpOnly: false, sameSite: 'None', secure: true}).cookie('_id', ((foundUser._id).toHexString()), {httpOnly: false, sameSite: 'None', secure: true}).cookie('profilePicUrl', foundUser.profilePicUrl ? foundUser.profilePicUrl : '', {httpOnly: false, sameSite: 'None', secure: true}).status(200).json(new ApiResponse(200, 'Logged In Successfully'))    
                    return
                }
